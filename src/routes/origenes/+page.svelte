    ...
    >
      <div bind:this={historia}>
        <p class:animate={intersectingHistoria}>
          ...
          no solamente fue el primer Mezcal de Mexico, si no probablemente el
          ...
          <span class="bold-text"
            >en el productor mas grande de destilados en el país y en el
            continente</span
          >. Como toda buena historia, sufre su tragedia después de la
          revolución, donde mas de 200 fabricas se vieron forzadas a cerrar sus
