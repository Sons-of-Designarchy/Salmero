...
<FeaturedImage title="Nuestra tierra" caption="Expresión pura de tradiciones">
  ...
  >
    <p>
      ...
      DONDE LOS BRAVOS SE JUNTAN CON LOS CIVILIZADOS, DONDE EL DESIERTO IMPONE
      SU LEY Y DEJA VIVIR SOLO A LOS MÁS RESILIENTES.
    </p>
    <p>
      <span class="bold-text">ORgULLO POTOSINO</span> QUE RINDE HOMENAJE A LA
      UNIÓN DE DOS MUNDOS COMO EL MISMO SAN LUIS.
      <span class="bold-text accent-text">SALMERO</span> ES LA REPRESENTACIÓN
      COMPLETA DEL <span class="bold-text">ALTIPLANO</span>.
    </p>
  </section>
</FeaturedImage>
...
<FeaturedImage title="Nuestra historia" caption="Expresión pura de tradiciones">
  ...
  >
    <p>
      ...
      introdujeron el primer alambique para procesar Mezcal en México, donde no
      solamente fue el primer Mezcal de Mexico, si no probablemente el primer
      destilado en todo el continente americano. De esta forma,
